...
public interface RecordService {
	 ...
	 * {@link #getRecord(java.lang.String) getRecord}), both persistent and temporary.
	 *
	 * @param globalId id for the record
	 * @throws RecordNotExistsException thrown if provided id is not registered id in the eCloud system.
	 */
	 ...
	 * @throws RepresentationNotExistsException thrown if there is no representation for provided record and schema or
	 * such representation exists but is not persistent.
	 */
	 ...
	 * @param version version of the representation
	 * @throws RepresentationNotExistsException such representation does not exist in specified version.
	 * @throws CannotModifyPersistentRepresentationException specified representation version is persistent and cannot
	 * deleted.
	 */
	 ...
	 * was updated.
	 * @throws RepresentationNotExistsException representation does not exist in specified version.
	 * @throws CannotModifyPersistentRepresentationException specified representation version is persistent so its files
	 * cannot be modified.
	 */
	 ...
	 * should be provided in this parameter for subsequent result slices.
