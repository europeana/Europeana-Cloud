...
public class RepresentationSolrDocument {
	...
	public RepresentationSolrDocument(String cloudId, String version, String schema, String providerId, Date creationDate, boolean persistent) {
		this.cloudId = cloudId;
		this.version = version;
		this.schema = schema;
		this.providerId = providerId;
	...
	public RepresentationSolrDocument(String cloudId, String version, String schema, String providerId, Date creationDate, boolean persistent, Collection<String> dataSets) {
