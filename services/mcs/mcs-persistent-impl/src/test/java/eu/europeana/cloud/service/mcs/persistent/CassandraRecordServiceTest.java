...
public class CassandraRecordServiceTest extends CassandraTestBase {
	...
	public void shouldListAllRepresentationVersionsInOrder() throws Exception {
		...
		Representation r5 = cassandraRecordService.createRepresentation(
				"globalId", "dc", providerId);
		Representation rep_another_schema = cassandraRecordService
				.createRepresentation("globalId", "jpg", providerId);
	...
	@Test
	public void shouldReturnWholeRecord() throws Exception {
		reset();
		makeUISSuccess();
		makeUISProviderSuccess();
		// only temp representation
		Representation dc = cassandraRecordService.createRepresentation(
				"globalId", "dc", providerId);

		// only persistent representation
		Representation jpg = insertDummyPersistentRepresentation("globalId",
				"jpg", providerId);

		// mixture of persistent and temp representations
		Representation edm1 = cassandraRecordService.createRepresentation(
				"globalId", "edm", providerId);
		Representation edm2 = insertDummyPersistentRepresentation("globalId",
				"edm", providerId);
		Representation edm3 = cassandraRecordService.createRepresentation(
				"globalId", "edm", providerId);
		Representation edm4 = insertDummyPersistentRepresentation("globalId",
				"edm", providerId);
		Representation edm5 = cassandraRecordService.createRepresentation(
				"globalId", "edm", providerId);
		...
		Record record = cassandraRecordService.getRecord("globalId");
		Set<Representation> expectedRepresentations = new HashSet<>(
				Arrays.asList(jpg, edm4));
		Set<Representation> fetchedRepresentations = new HashSet<>(
				record.getRepresentations());
	...
	public void shouldDeleteRepresentationInSpecifiedVersion() throws Exception {
		...
		cassandraRecordService.deleteRepresentation(r1.getRecordId(),
				r1.getSchema(), r1.getVersion());
	...
	public void shouldDeleteAllRepresentationVersions() throws Exception {
		...
		assertTrue(cassandraRecordService.listRepresentationVersions(
				"globalId", "dc").isEmpty());
	}
	...
	public void shouldNotDeletePersistentRepresentation() throws Exception {
		...
		Representation r = insertDummyPersistentRepresentation("globalId",
				"dc", providerId);
		cassandraRecordService.deleteRepresentation(r.getRecordId(),
	...
	public void shouldNotAddFileToPersistentRepresentation() throws Exception {
		...
		cassandraRecordService.putContent(r.getRecordId(), r.getSchema(),
				r.getVersion(), f, new ByteArrayInputStream(dummyContent));
	}
	...
	public void shouldNotRemoveFileFromPersistentRepresentation()
		...
		cassandraRecordService.deleteContent(r.getRecordId(), r.getSchema(),
				r.getVersion(), f.getFileName());
	}
	...
	public void shouldNotPersistRepresentationWithoutFile() throws Exception {
		...
		Representation r = cassandraRecordService.createRepresentation(
				"globalId", "edm", providerId);
		cassandraRecordService.persistRepresentation(r.getRecordId(),
				r.getSchema(), r.getVersion());
	}
	...
	public void shouldPutAndGetFile() throws Exception {
		...
		r = cassandraRecordService.getRepresentation(r.getRecordId(),
				r.getSchema(), r.getVersion());
	...
	public void shouldGetContent() throws Exception {
		...
		ByteArrayOutputStream baos = new ByteArrayOutputStream(
				dummyContent.length);
		cassandraRecordService.getContent(r.getRecordId(), r.getSchema(),
				r.getVersion(), f.getFileName(), baos);
	...
	public void shouldCopyRepresentation() throws Exception {
		...
		Representation copy = cassandraRecordService.copyRepresentation(
				r.getRecordId(), r.getSchema(), r.getVersion());
		...
		for (File f : r.getFiles()) {
			...
			cassandraRecordService.getContent(r.getRecordId(), r.getSchema(),
					r.getVersion(), f.getFileName(), rContent);
			cassandraRecordService.getContent(copy.getRecordId(),
					copy.getSchema(), copy.getVersion(), f.getFileName(),
					copyContent);
	...
	private Representation insertDummyPersistentRepresentation(String cloudId,
		...
		return cassandraRecordService.persistRepresentation(r.getRecordId(),
				r.getSchema(), r.getVersion());
	}
