    ...
    public void validate(){
        ...
        while (rs.iterator().hasNext()){
            ...
            Assert.assertTrue(error_message.equals("javax.ws.rs.InternalServerErrorException: HTTP 500 Internal Server Error\n" +
                    ...
                    "\t... 30 more\n") || error_message.equals("java.lang.IllegalStateException: The template variable 'F80A579D-DBA3-5AE6-E044-001A4B08D326' has no value\n" +
            ...
            Assert.assertTrue("http://195.216.97.81:8080/mcs/records/2WYNVPQMZHEO6HVDGIVTR4IKEB54FHH2X274YDW6NXSF25KI75NA/representations/IC_REPRESENTATION/versions/5eaea4d0-ceac-11e7-b72d-fa163e1e1541/files/0a8573e1-13a0-4431-bfb2-ce73fded7e5d".equals(resource)
                || "http://195.216.97.81:8080/mcs/records/2WYNVPQMZHEO6HVDGIVTR4IKEB54FHH2X274YDW6NXSF25KI75NA/representations/IC_REPRESENTATION/versions/5eaea4d0-ceac-11e7-b72d-fa163e1e1541/files/5133488d-03d9-4bb5-851c-67bfdbcd8542".equals(resource)
