...
public class MigrationExecutorTest {
  ...
  public void shouldSuccessfullyMigrateData() {
    //given
    MigrationExecutor migrator = new MigrationExecutor(EmbeddedCassandra.KEYSPACE, contactPoint, EmbeddedCassandra.PORT,
        cassandraUsername, cassandraPassword, scriptsLocations);
  ...
  public void shouldSuccessfullyMigrateDataInUIS() {
    ...
    final String[] scriptsLocations1 = new String[]{"migrations/service/uis",
        "testMigrations/uis"};
    MigrationExecutor migrator = new MigrationExecutor(EmbeddedCassandra.KEYSPACE, contactPoint, EmbeddedCassandra.PORT,
        cassandraUsername, cassandraPassword, scriptsLocations1);
    //when
    migrator.migrate();
