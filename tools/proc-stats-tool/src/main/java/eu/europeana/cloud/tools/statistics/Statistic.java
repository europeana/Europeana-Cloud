...
public class Statistic {
  ...
  /**
   * Increase number of min and max by 1 For first line this both values are just 1
   *
   ...
   *
   * @param firstLine Flag if first line from file is processed
   * @param opened Number of opened connections do not count min value for first line if no opened connections (opened == 0)
