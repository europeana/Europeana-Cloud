...
public class FoodAndDrinkResourceProvider
  ...
  /**
   * Return local record identifier from the path to image file. Path must contain provider identifier and must point to the
   * file.
   *
  ...
  /**
   * Input path must point to the file that is either the properties file or the directory that contains properties file named
   * id.properties where id is identifier of data provider used in ECloud
   *
