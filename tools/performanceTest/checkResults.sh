...
sh  ~/jenkins/performanceTest/performanceTestScript.sh "$@" --host localhost --port 8080 --HTTP --threads 2 --loops 2 --Auth admin ecloud_admin | tee ~/jenkins/performanceTest/results.txt
