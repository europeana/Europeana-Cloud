...
public class RevisionInformation {
    ...
    public RevisionInformation(String dataSet, String providerId, String representationName, String revisionName, String revisionProvider, String revisionTimeStamp) {
