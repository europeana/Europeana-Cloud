  ...
  static {
    try {
      ...
      throw new ConfigFileLoadException(
          "Could not load configuration file! Valid configuration file named config.properties - based on config.properties.template should be present in program root directory.",
          e);
    }
  }
