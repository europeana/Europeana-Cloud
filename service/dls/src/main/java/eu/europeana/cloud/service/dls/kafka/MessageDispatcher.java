...
/**
 * MessageDispatcher routes message to an appropriate message listener based on message class.
 * Initializes  listenersMap - a routing table containg message class - processor class associations. 
 */
@Component
