...
/**
 * Verifies if provided {@link DpsTask} has input revision that is fully defined. Fully defined revision means that
 * all its properties are provided (provider_id, revisionName and revisionTimestamp)
 *
 */
