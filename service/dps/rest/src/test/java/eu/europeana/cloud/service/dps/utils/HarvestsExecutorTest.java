...
@PowerMockIgnore({"javax.management.*", "javax.security.*", "javax.net.ssl.*", "org.apache.commons.codec.digest.*",
        "org.apache.logging.log4j.*", "com.sun.org.apache.xerces.*"})
public class HarvestsExecutorTest {
    ...
    public void shouldEmitAllRecordsToKafka() throws HarvesterException {
        ...
        verify(recordSubmitService).submitRecord(
                argThat(samePropertyValuesAs(DpsRecord.builder().taskId(task.getTaskId()).recordId(OAI_ID_1).markedAsDeleted(false).build()))
                , any());
    }
