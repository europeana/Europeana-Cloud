...
import eu.europeana.cloud.service.dps.http.GzUnpackingService;
...
public class GzUnpackingServiceTest {
    ...
    @Test
    public void shouldUnpackTheTarGzFilesRecursivelyWithCompressedXMLFiles() throws CompressionExtensionNotRecognizedException, IOException {
