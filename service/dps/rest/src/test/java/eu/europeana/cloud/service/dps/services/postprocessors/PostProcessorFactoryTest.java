...
class PostProcessorFactoryTest {
    ...
    @Test
    void shouldChooseValidPostProcessor() {
    ...
    @Test
    void shouldFailForUnknownTopologyProcessor() {
        var taskByTaskState = TaskByTaskState.builder().topologyName("STRANGE_TOPOLOGY").build();
        assertThrows(PostProcessingException.class, () -> postProcessorFactory.getPostProcessor(taskByTaskState));
    }
    ...
    private void shouldReturnAppropriatePostProcessor(TaskPostProcessor expectedPostProcessor, String topologyName) {
        ...
        assertSame(expectedPostProcessor, postProcessorFromFactory);
    }
