...
public class IndexWrapperInstance {
    ...
    //private static final String CASSANDRA_CONNECTION_FILE_NAME = "<PATH_TO_CONFIGURATION_PROJECT>/production/topologies/indexing_topology_config.properties";
    ...
    public static CassandraConnectionProvider getProvider(){
        ...
        CassandraConnectionProvider provider =
                CassandraConnectionProviderSingleton.getCassandraConnectionProvider(properties.getProperty(CASSANDRA_HOSTS),
