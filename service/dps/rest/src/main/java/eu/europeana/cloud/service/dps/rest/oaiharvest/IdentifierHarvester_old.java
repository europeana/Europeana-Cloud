 ...
 */
public class IdentifierHarvester_old implements Callable<Void> {
    ...
    public IdentifierHarvester_old(String topologyName, OAIItem oaiItem, CassandraTaskInfoDAO cassandraTaskInfoDAO, RecordExecutionSubmitService recordExecutionSubmitService, TaskStatusChecker taskStatusChecker) {
