...
public class OaiPmhTopologyCategorizationServiceTest {
    ...
    @Test
    void shouldCategorizeRecordAsReadyForProcessingInCaseOfExistingDefinitionInDBAndNewHarvestedRecord() {
        //given
        HarvestedRecordsDAO harvestedRecordsDAO = Mockito.mock(HarvestedRecordsDAO.class);
    ...
    @Test
    void shouldCategorizeRecordAsReadyForProcessingInCaseOfRecordThatIsNotChangedButFallsIntoBuffer() {
        //given
        HarvestedRecordsDAO harvestedRecordsDAO = Mockito.mock(HarvestedRecordsDAO.class);
        Instant previewHarvestDate =
    ...
    @Test
    void shouldCategorizeRecordAsNotReadyForProcessingInCaseOfExistingDefinitionInDBAndOldRecord() {
        //given
        HarvestedRecordsDAO harvestedRecordsDAO = Mockito.mock(HarvestedRecordsDAO.class);
    ...
    void shouldCategorizeRecordAsReadyForProcessingInCaseOfPreviewDateIsNull() {
        //given
        HarvestedRecordsDAO harvestedRecordsDAO = Mockito.mock(HarvestedRecordsDAO.class);
        //        Date dateOfHarvesting = new Date();
        Instant recordDateStamp =
    ...
    void shouldCategorizeRecordAsReadyForProcessingInCaseOfPreviewDateIsOld() {
        //given
        HarvestedRecordsDAO harvestedRecordsDAO = Mockito.mock(HarvestedRecordsDAO.class);
        Instant recordDateStamp =
                LocalDateTime.of(1990, 1, 10, 10, 15).toInstant(ZoneOffset.UTC);
    ...
    @Test
    void shouldCategorizeRecordAsReadyForProcessingInCaseOfEqualsRecordDatestampAndPublishedHarvestDate() {
        //given
        HarvestedRecordsDAO harvestedRecordsDAO = Mockito.mock(HarvestedRecordsDAO.class);
        Instant recordDateStamp =
    ...
    @Test
    void shouldCategorizeRecordAsReadyForProcessingInCaseOfExistingDefinitionInDBAndOldRecordButFullHarvest() {
        //given
        HarvestedRecordsDAO harvestedRecordsDAO = Mockito.mock(HarvestedRecordsDAO.class);
        Instant recordDateStamp =
                LocalDateTime.of(1990, 1, 10, 10, 15).toInstant(ZoneOffset.UTC);
