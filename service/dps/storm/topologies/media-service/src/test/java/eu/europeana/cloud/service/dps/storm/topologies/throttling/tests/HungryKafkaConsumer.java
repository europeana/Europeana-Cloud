...
public class HungryKafkaConsumer {
   ...
   //     props.put("fetch.max.bytes", 3000);
        ...
        props.put("group.id" , "a_throttling_testing_topology");
    ...
    public static void main(String[] args) {
        HungryKafkaConsumer tester = new HungryKafkaConsumer();
        tester.consume();
    }
