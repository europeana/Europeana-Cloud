...
import eu.europeana.cloud.service.dps.storm.topologies.xslt.XSLTTopology;
...
public class XSLTTopologyTest {
  ...
  @Test
  public void shouldProperlyBuildXSLTTopology(){
    XSLTTopology xsltTopology = new XSLTTopology("defaultXSLTTopologyConfig.properties", "");
    ...
    ComponentCommon xsltBoltCommon = topology.get_bolts().get(TopologyHelper.XSLT_BOLT).get_common();
    assertEquals(1, xsltBoltCommon.get_inputs_size());
    assertEquals(2, xsltBoltCommon.get_streams_size());
    assertEquals(DEFAULT_PROPERTIES_BOLT_PARALLELISM, xsltBoltCommon.get_parallelism_hint());
  }
}
