...
@PrepareForTest({ReadFileBolt.class, IcBolt.class, WriteRecordBolt.class, RevisionWriterBolt.class, AddResultToDataSetBolt.class, NotificationBolt.class, CassandraConnectionProviderSingleton.class, CassandraTaskInfoDAO.class, CassandraSubTaskInfoDAO.class, CassandraTaskErrorsDAO.class, ImageConverterServiceImpl.class, CassandraResourceProgressDAO.class, TaskStatusChecker.class})
