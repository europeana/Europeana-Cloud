...
public class HttpTopologyCategorizationService extends HarvestedRecordCategorizationService {
  ...
  private boolean hashesMismatchForPreviewEnv(HarvestedRecord harvestedRecord,
      CategorizationParameters categorizationParameters) {
  ...
  private boolean hashesMismatchForPublishEnv(HarvestedRecord harvestedRecord,
      CategorizationParameters categorizationParameters) {
