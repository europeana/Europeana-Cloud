...
@PrepareForTest({ReadFileBolt.class, NormalizationBolt.class, ValidationRevisionWriter.class, NotificationBolt.class, CassandraConnectionProviderSingleton.class, CassandraTaskInfoDAO.class, CassandraSubTaskInfoDAO.class, CassandraTaskErrorsDAO.class, CassandraNodeStatisticsDAO.class, CassandraResourceProgressDAO.class, WriteRecordBolt.class, ReadFileBolt.class, TaskStatusChecker.class})
