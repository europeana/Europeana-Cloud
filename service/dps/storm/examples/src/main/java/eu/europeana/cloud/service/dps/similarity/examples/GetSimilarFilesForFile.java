...
public class GetSimilarFilesForFile 
{
    ...
    {
        SimilarityService ss = new SimilarityService(indexers[0], "index_mlt_3", "mlt3", addresses[0]);

        System.out.println("------  Similarities  ------");
        
        SearchResult similarDocuments = ss.getSimilarDocuments(file3, 4);
        ...
        List<SearchHit> duplicateDocuments = ss.calcDuplicateDocuments(file3);
