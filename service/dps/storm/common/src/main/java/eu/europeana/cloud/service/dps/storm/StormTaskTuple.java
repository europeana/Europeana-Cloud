 ...
 * 
 * Useful to track progress of a Task as tuples emitted from different tasks
 * are being processed.
 * 
 * @author manos
 */
public class StormTaskTuple implements Serializable {
    ...
    public StormTaskTuple(long taskId, String taskName, String fileUrl, String fileData, HashMap<String, String> parameters) {
