...
public abstract class HarvestedRecordCategorizationService {
  ...
  protected abstract boolean isRecordEligibleForProcessing(HarvestedRecord harvestedRecord,
  ...
  private void updateRecordLatestHarvestDateAndMd5(HarvestedRecord harvestedRecord,
      CategorizationParameters categorizationParameters) {
  ...
  private CategorizationResult categorizeRecordAsReadyForProcessing(CategorizationParameters categorizationParameters,
  ...
  private CategorizationResult categorizeRecordAsNotReadyForProcessing(CategorizationParameters categorizationParameters,
      HarvestedRecord harvestedRecord) {
    return CategorizationResult
        .builder()
