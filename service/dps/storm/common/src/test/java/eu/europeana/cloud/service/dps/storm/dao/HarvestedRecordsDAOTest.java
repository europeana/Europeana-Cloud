...
class HarvestedRecordsDAOTest extends CassandraTestBase {
    ...
    @Test
    void shouldFindInsertedRecords() {
    ...
    @Test
    void shouldReturnEmptyOptionalWhenNoRecordFound() {
    ...
    @Test
    void shouldIterateThrowDatasetRecords() {
    ...
    @Test
    void shouldCompleteEmptyPreviewColumns() {
        dao.insertHarvestedRecord(builder().metisDatasetId(METIS_DATASET_ID).recordLocalId(OAI_ID_1)
    ...
    @Test
    void shouldCreateRowIfDoesNotExistWhenCompletingPreviewColumns() {
        db.getSession().execute(dao.createUpdateIndexedColumnsIfEmptyHarvestDateStatement(
                METIS_DATASET_ID, OAI_ID_1, PREVIEW, COMPLETED_DATE, COMPLETED_MD5));
    ...
    @Test
    void shouldCompleteEmptyPublishColumns() {
        dao.insertHarvestedRecord(builder().metisDatasetId(METIS_DATASET_ID).recordLocalId(OAI_ID_1)
                .latestHarvestDate(HARVESTED_DATE).latestHarvestMd5(MD5)
    ...
    @Test
    void shouldCreateRowIfDoesNotExistWhenCompletingPublishColumns() {
        db.getSession().execute(dao.createUpdateIndexedColumnsIfEmptyHarvestDateStatement(
                METIS_DATASET_ID, OAI_ID_1, PUBLISH, COMPLETED_DATE, COMPLETED_MD5));
