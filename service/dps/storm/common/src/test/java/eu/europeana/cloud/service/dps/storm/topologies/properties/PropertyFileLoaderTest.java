...
public class PropertyFileLoaderTest {
    ...
    @Test
    void testLoadingDefaultPropertiesFile() throws IOException {
    ...
    @Test
    void testLoadingProvidedPropertiesFile() throws IOException {
    ...
    @Test
    void testLoadingNonExistedDefaultFile() {
        assertThrows(FileNotFoundException.class, () -> reader.loadDefaultPropertyFile("NON_EXISTED_FILE", topologyProperties));
    }

    @Test
    void testLoadingNonExistedProvidedFile() {
        assertThrows(FileNotFoundException.class, () -> reader.loadProvidedPropertyFile("NON_EXISTED_FILE", topologyProperties));
    }
    ...
    @Test
    void testLoadingFileWhenDefaultFileNotExists() {
