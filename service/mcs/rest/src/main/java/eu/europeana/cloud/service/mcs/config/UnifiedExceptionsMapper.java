...
public class UnifiedExceptionsMapper {
     ...
     * status code 405 - "Method Not Allowed" and a {@link ResponseEntity<ErrorInfo>} with exception details as a message body.
     *
     ...
     * "Requested Range Not Satisfiable" and a {@link ResponseEntity<ErrorInfo>} with exception details as a message body.
     *
     * @param exception the exception to map to a response
     * @return a response mapped from the supplied exception
     */
     ...
     * "Internal Server Error" and a {@link ResponseEntity<ErrorInfo>} with exception details as a message body.
     *
     * @param exception the exception to map to a response
     * @return a response mapped from the supplied exception
     */
     ...
     * "Method not Allowed" and a {@link ResponseEntity<ErrorInfo>} with exception details as a message body.
     *
     * @param exception the exception to map to a response
     * @return a response mapped from the supplied exception
     */
