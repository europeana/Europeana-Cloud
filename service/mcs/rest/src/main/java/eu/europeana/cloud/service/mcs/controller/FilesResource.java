...
public class FilesResource {
   ...
   */
  @Timed(value = "file_upload_duration", description = "Duration of file upload operations", histogram = true)
  @Counted(value = "file_upload_counter", description = "Number of file upload operations")
