...
class StorageSelectorTest {
    ...
    void shouldDetectStorage(String fileName, String expectedDecision, String mediaType) throws
            IOException {
        //given
    ...
    void shouldThrowBadRequestOnDifferentMimeTypeProvidedByUser(String fileName,
                                                                String mediaType)
            throws IOException {
        //given
        URL resource = Resources.getResource(fileName);
