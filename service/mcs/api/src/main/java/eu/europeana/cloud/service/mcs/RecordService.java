...
public interface RecordService {
     ...
     */
    List<RepresentationRevisionResponse> getRepresentationRevision(String globalId, String schema, String revisionProviderId, String revisionName, Date revisionTimestamp);
