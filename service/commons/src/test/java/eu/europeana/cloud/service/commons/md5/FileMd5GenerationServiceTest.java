...
public class FileMd5GenerationServiceTest {
    ...
    public void shouldGenerateDifferentMd5ForSlightlyDifferentFilesProvidedAsByteArrays() throws IOException {
        UUID record1 = FileMd5GenerationService.generateUUID(FileUtils.readFileToByteArray(new File(ClassLoader.getSystemResource("Lithuania_1.xml").getFile())));
        UUID record2 = FileMd5GenerationService.generateUUID(FileUtils.readFileToByteArray(new File(ClassLoader.getSystemResource("Lithuania_1_1.xml").getFile())));
        assertNotSame(record1, record2);
    }
    ...
    public void shouldGenerateTheSameMd5ForSameFile() throws URISyntaxException, IOException {
        UUID record1 = FileMd5GenerationService.generateUUID(Paths.get(ClassLoader.getSystemResource("Lithuania_1.xml").toURI()));
        UUID record2 = FileMd5GenerationService.generateUUID(Paths.get(getClass().getClassLoader().getResource("Lithuania_1.xml").toURI()));
    ...
    public void shouldGenerateTheSameMd5ForSameFileProvidedAsByteArray() throws IOException {
        UUID record1 = FileMd5GenerationService.generateUUID(FileUtils.readFileToByteArray(new File(ClassLoader.getSystemResource("Lithuania_1.xml").getFile())));
        UUID record2 = FileMd5GenerationService.generateUUID(FileUtils.readFileToByteArray(new File(ClassLoader.getSystemResource("Lithuania_1.xml").getFile())));
        assertEquals(record1, record2);
    }
    ...
    public void shouldGenerateDifferentMd5ForDifferentFilesProvidedAsByteArrays() throws IOException {
        UUID record1 = FileMd5GenerationService.generateUUID(FileUtils.readFileToByteArray(new File(ClassLoader.getSystemResource("Lithuania_1.xml").getFile())));
        UUID record1_1 = FileMd5GenerationService.generateUUID(FileUtils.readFileToByteArray(new File(ClassLoader.getSystemResource("Lithuania_1_1.xml").getFile())));
        UUID record2 = FileMd5GenerationService.generateUUID(FileUtils.readFileToByteArray(new File(ClassLoader.getSystemResource("Lithuania_2.xml").getFile())));
        UUID record3 = FileMd5GenerationService.generateUUID(FileUtils.readFileToByteArray(new File(ClassLoader.getSystemResource("Lithuania_3.xml").getFile())));
        UUID record4 = FileMd5GenerationService.generateUUID(FileUtils.readFileToByteArray(new File(ClassLoader.getSystemResource("Lithuania_4.xml").getFile())));
    ...
    public void shouldGenerateTheSameUUIDsAsEarlier() throws URISyntaxException, IOException {
        assertEquals(UUID.fromString("de709ba0-6d52-31e5-a7c1-24793dca071d"), FileMd5GenerationService.generateUUID(FileUtils.readFileToByteArray(new File(ClassLoader.getSystemResource("Lithuania_1.xml").getFile()))));
        assertEquals(UUID.fromString("7d13c967-fcb9-3dbf-8243-0ae4c03bb299"), FileMd5GenerationService.generateUUID(FileUtils.readFileToByteArray(new File(ClassLoader.getSystemResource("Lithuania_1_1.xml").getFile()))));
        assertEquals(UUID.fromString("75b85fde-42be-3cd0-87d6-693485ec3124"), FileMd5GenerationService.generateUUID(FileUtils.readFileToByteArray(new File(ClassLoader.getSystemResource("Lithuania_2.xml").getFile()))));
        assertEquals(UUID.fromString("79071711-1865-3d60-b872-665be230000d"), FileMd5GenerationService.generateUUID(FileUtils.readFileToByteArray(new File(ClassLoader.getSystemResource("Lithuania_3.xml").getFile()))));
        assertEquals(UUID.fromString("e3d4dd38-9b62-39a6-b03d-a86e54ef64f2"), FileMd5GenerationService.generateUUID(FileUtils.readFileToByteArray(new File(ClassLoader.getSystemResource("Lithuania_4.xml").getFile()))));
