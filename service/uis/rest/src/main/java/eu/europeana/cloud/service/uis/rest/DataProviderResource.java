...
public class DataProviderResource {
	...
	public DataProvider getProvider() throws ProviderDoesNotExistException {
	...
	public void updateProvider(DataProviderProperties dataProviderProperties) throws ProviderDoesNotExistException {
	...
	@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
	public Response createIdMapping(@QueryParam("localId") String localId) throws DatabaseConnectionException,
