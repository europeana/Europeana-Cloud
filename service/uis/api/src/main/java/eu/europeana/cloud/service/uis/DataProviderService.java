...
public interface DataProviderService {
   ...
   *
   * @param thresholdProviderId if null - will return first result slice. Result slices contain token for next pages, which should
   ...
   * @throws ProviderDoesNotExistException if threre is no provider with such id.
   */
   ...
   * @throws ProviderAlreadyExistsException provider with this id already exists
   */
