 ...
 */
package eu.europeana.aas.authorization.model;
...
public class AclEntry {
  ...
  /**
   * @return the identifier of this <code>AclEntry</code>. The identifier follows the pattern 'objectClass:objectId:sid:order'.
   */
  public String getId() {
    return id;
  }
  ...
  /**
   * @return true if the Sid for this <code>AclEntry</code> is of type {@link PrincipalSid} of false if it is of type
  ...
  /**
   * @return the order of this <code>AclEntry</code> in the list of Acl entries for the related domain object.
   */
  public int getOrder() {
    return order;
  }
  ...
  /**
   * @param order the order of this <code>AclEntry</code> in the list of Acl entries for the related domain object.
   */
