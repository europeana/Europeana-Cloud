...
public class CassandraAclRepositoryImpl implements CassandraAclRepository {
	 ...
	 */
	public CassandraAclRepositoryImpl(DatabaseService databaseService, boolean initSchema) {
	 ...
	 * @param session the <code>Session</code> to use for connectivity with Cassandra.
	 */
	public CassandraAclRepositoryImpl(Session session, String keyspace) {
	 ...
	 */
	public CassandraAclRepositoryImpl(Session session, String keyspace, boolean initSchema, String replicationStrategy, int replicationFactor) {
	 ...
	 * @param initSchema whether the keyspace and schema for storing ACLs should be created.
	 */
	public CassandraAclRepositoryImpl(Session session, String keyspace, boolean initSchema) {
		this(session, keyspace);
		if (initSchema) {
			createkeyspace();
			createAoisTable();
