...
public enum StatusCode {
    ...
    DATABASECONNECTIONERROR {
        @Override
        public String getDescription(String... args) {
            return String.format("The connection to the DB %s:%s/%s failed with error %s", args[0],
    ...
    RECORDEXISTS {
        ...
        public String getDescription(String... args) {
            return String.format(
                    "The identifier %s for provider id %s and record id %s already exists in the database",
    ...
    RECORDIDDOESNOTEXIST {
        @Override
        public String getDescription(String... args) {
            return String.format("The supplied record identifier %s does not exist", args[0]);
        }
