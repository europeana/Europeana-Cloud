...
public class TaskCountersAggregator {
    ...
    /**
     * Calculates the number of records that are ready to be processed by the next topology in the workflow.
     * This value will be used as 'expected_records_number' in the next step in the workflow.
     *
